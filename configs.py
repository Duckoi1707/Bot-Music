...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/BotMusicUpdates")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/BotMusicChat")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Duckoi1707/Bot-Music")
